<div id="page-wrapper">
    <div class="container-fluid">
        <div class="row"><br>
            ...
            <?php } ?>
            <div class="col-lg-12">
                <h2 class="page-header"><i class="fa fa-fw fa-laptop"></i>New Client
                </h2>
            </div><br>
            <div class="col-sm-12">
                <form class="form-horizontal form-syntesa" method="post" action="<?php echo site_url('manage/client/edit/'.$id_client) ?>" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <textarea class="form-control text-area-control"  name="description" rows="5"><?php echo set_value('description') ?></textarea>
                        </div>
