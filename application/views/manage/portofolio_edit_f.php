                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <select class="form-control" name="type">
                                ...
                                <option value="company" <?php echo ((set_value('type')==="company")?"selected":"")?>>Company Profile</option>
                                <option value="shop" <?php echo ((set_value('type')==="shop")?"selected":"")?>>Online Shop</option>
                            </select>
                        </div>
