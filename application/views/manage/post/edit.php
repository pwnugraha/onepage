<div class="container-fluid">
    <div class="row">
        ...
        <?php } ?>
        <div class="col-lg-12">
            <h2 class="page-header"><i class="fa fa-fw fa-edit"></i>Edit <?php echo ucwords($uri) ?>
            </h2>
        </div><br>
        <div class="col-sm-12">
            <?php echo form_open('manage/post/edit/' . $post_type . '/' . $id_page, 'id="fileupload" enctype="multipart/form-data"'); ?>
            <div class="col-sm-9">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control input-lg" id="title" name="title" value="<?php echo $post['title'] ?>">
                        </div>
                        <div class="form-group">
                            <label class="control-label">Isi</label>
                            <textarea class="form-control text-area-control" name="ck_description_field" rows="5"><?php echo $post['description'] ?></textarea>
                        </div>
                    </div>
                </div>
                <div class="form-group">
            ...
            <div class="col-sm-3">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <p><i class="fa fa-fw fa-calendar"></i><strong>Diposting :</strong><br><i class="fa fa-fw"></i><?php echo 'Tanggal : ' . date('d-m-Y', strtotime($post['created'])) . '<br><i class="fa fa-fw"></i>Jam : ' . date('H:i', strtotime($post['created'])) ?></p>
                        <p><i class="fa fa-fw fa-clock-o"></i><strong>Terakhir diperbarui :</strong><br><i class="fa fa-fw"></i><?php echo 'Tanggal : ' . date('d-m-Y', strtotime($post['modified'])) . '<br><i class="fa fa-fw"></i>Jam : ' . date('H:i', strtotime($post['modified'])) ?></p>
                        <p><i class="fa fa-fw fa-eye"></i><strong>Status : </strong><br><i class="fa fa-fw"></i><?php echo (($post['publish'] == 'yes') ? "Publish" : "Draft") ?></p>
                ...
                <div class="form-group">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <input type="radio" <?php echo (($post['publish'] == "no") ? "checked" : "") ?> name="save_as" value="no"> Draft<br>
                            <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;atau</span><br>
                            <input type="radio" <?php echo (($post['publish'] == "yes") ? "checked" : "") ?> name="save_as" value="yes"> Publish sekarang<br>
                        </div>
                    </div>
                </div>
...
<?php
$this->load->view('manage/media/image/gallery')?>