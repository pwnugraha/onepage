<div class="container-fluid">
    <div class="row">
        ...
        <?php } ?>
        <div class="col-lg-12">
            <h2 class="page-header"><i class="fa fa-fw fa-edit"></i>Edit Artikel
            </h2>
        </div><br>
        <div class="col-sm-12">
            <?php echo form_open('manage/information/article/edit/' . $id_page, 'id="fileupload" enctype="multipart/form-data"'); ?>
            <div class="col-sm-9">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control text-area-control" name="ck_description_field"><?php echo $page['description'] ?></textarea>
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="input-group">
                                <span class="input-group-addon">laundry-in.com/article/read/</span>
            ...
            <div class="col-sm-3">
                ...
                <div class="panel panel-default">
                    <div class="panel-body text-center">
                        ...
                        <a href="<?php echo site_url('manage/information/article') ?>" class="btn btn-default">Kembali</a>
                    </div>
                </div>
            </div>
            <?php echo form_close(); ?>
