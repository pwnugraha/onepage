<div class="container-fluid">
    <div class="row">
        ...
        <?php } ?>
        <div class="col-lg-12">
            <h2 class="page-header"><i class="fa fa-fw fa-plus"></i>Tambah Artikel
            </h2>
        </div><br>
        <div class="col-sm-12">
            <?php echo form_open('manage/information/article/add', 'id="fileupload" enctype="multipart/form-data"'); ?>
            <div class="col-sm-9">
