<div id="page-wrapper">
    <div class="container-fluid">
        <div class="row"><br>
            ...
            <?php } ?>
            <div class="col-lg-12">
                <h2 class="page-header"><i class="fa fa-fw fa-external-link"></i> Company Profile <small>Product</small>
                </h2>
            </div><br>
                                ...
                                <tbody>
                                    ...
                                    foreach ($features as $v) {
                                        ...
                                        <tr>
                                            ...
                                            <td><input class="form-control text-center input-sm" name="bronze_<?php echo $i ?>" type="text" value="<?php echo set_value('bronze_' . $i) ?>"><span class="text-danger"><?php echo form_error('bronze_' . $i) ?></span></td>
                                            <td><input class="form-control text-center input-sm" name="silver_<?php echo $i ?>" type="text" value="<?php echo set_value('silver_' . $i) ?>"><span class="text-danger"><?php echo form_error('silver_' . $i) ?></span></td>
                                            <td><input class="form-control text-center input-sm" name="gold_<?php echo $i ?>" type="text" value="<?php echo set_value('gold_' . $i) ?>"><span class="text-danger"><?php echo form_error('gold_' . $i) ?></span></td>
