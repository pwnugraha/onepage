    ...
    <div class="row"><br>
        ...
        <div class="col-sm-12">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6 text-danger control-label text-align-left"><?php echo form_error('oldpassword') ?></div>
            </div><br>
            <div class="form-group">
                ...
                <div class="col-sm-6 text-danger control-label text-align-left"><?php echo form_error('password') ?></div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-6 text-danger control-label text-align-left"><?php echo form_error('repass') ?></div>
            </div>
