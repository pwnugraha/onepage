<div id="page-wrapper">
    <div class="container-fluid">
        ...
        <form class="form-horizontal" style="padding-bottom: 50px; margin-bottom: 50px;" method="post" action="<?php echo site_url('manage/config/general/upd_generalconfig') ?>">
            ...
            <hr><h4 class="text-muted">Contact Info</h4>
            <div class="form-group">
            ...
            <hr><h4 class="text-muted">Social Media</h4>
            <div class="form-group">
            ...
            <hr><h4 class="text-muted">Tentang Gome</h4>
             <div class="form-group">
                <label class="col-sm-2 control-label  text-align-left">Tentang Gome</label>
                <div class="col-sm-6">
                    <textarea class="form-control text-area-control" rows="8" name="about_gome"><?php echo $set['about_gome'] ?></textarea> 
                </div>
                <label style="text-align: left" class="col-sm-3 control-label text-danger"><?php echo form_error('about_gome') ?></label>
            </div>
