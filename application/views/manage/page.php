<div class="container-fluid">
    <div class="row">
        ...
        <?php } ?>
        <div class="col-lg-12">
            <h2 class="page-header"><i class="fa fa-fw fa-paperclip"></i>Halaman
            </h2>
        </div><br>
    </div>
    <?php echo form_open(site_url('manage/page/delete_all'), 'id="delall"') ?>
    <div class="col-lg-12">
        <?php if ($page) { ?>
        ...
        <div class="text-right">
            <a href="<?php echo site_url('manage/page/add') ?>" class="btn btn-default"><i class="fa fa-fw fa-plus"></i>&nbsp;Halaman Baru</a>
        </div>
    </div><br>
    <?php if ($page == FALSE) { ?>
        <br>
        <h4 class="text-center">Data Halaman kosong. Klik 'Halaman Baru' untuk menambahkan halaman</h4>
    <?php } else { ?>
        <div class="col-lg-12">
            <div class="row">
                                ...
                                foreach ($page as $i) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="<?php echo site_url('manage/page/edit/' . $i['id']) ?>" class="btn btn-default btn-sm" title="Edit"><i class="fa fa-edit text-primary"></i></a>
                                            <button id="delete" type="button" class="btn btn-default btn-sm" data-url="<?php echo site_url('manage/page/delete/' . $i['id']) ?>" data-toggle="modal" data-target="#delete-modal" data-backdrop="static" data-keyboard="false" title="Hapus"><i class="fa fa-close text-danger"></i></button>
                                        </td>
                                    </tr>
                                    <?php
                                    $no+=1;
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content modal-confirm">
            <div class="modal-body text-center text-semi-bold">
                ...
                <p>Halaman ini akan dihapus. Lanjutkan ?</p>
