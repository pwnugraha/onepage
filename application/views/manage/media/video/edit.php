                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="title" name="title" value="<?php echo $media['title'] ?>">
                        </div>
                        <div class="form-group">
                            ...
                            <textarea class="form-control text-area-control" rows="3" name="embed"><?php echo $media['description'] ?></textarea>
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control"  name="url" value="<?php echo $media['url'] ?>">
                        </div>
                        <div class="form-group">
                            <label class="control-label">Caption</label>
                            <textarea class="form-control text-area-control" rows="3" name="caption"><?php echo $media['caption'] ?></textarea>
                        </div>
