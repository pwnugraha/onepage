<div class="container-fluid">
    <div class="row">
        ...
        <?php } ?>
        <div class="col-lg-12">
            <h2 class="page-header"><i class="fa fa-fw fa-play-circle-o"></i>Video
            </h2>
        </div><br>
    </div>
    <?php echo form_open(site_url('manage/media/video/delete_all'), 'id="delall"') ?>
    <div class="col-lg-12">
        <?php if ($media) { ?>
        ...
        <div class="text-right">
            <a href="<?php echo site_url('manage/media/video/create') ?>" class="btn btn-default"><i class="fa fa-fw fa-plus"></i>&nbsp;Tambahkan Video</a>
        </div>
    </div><br>
    <?php if ($media == FALSE) { ?>
        <br>
        <h4 class="text-center">Data Video kosong. Klik 'Tambahkan Video' untuk menambahkan video</h4>
    <?php } else { ?>
        <div class="col-lg-12">
            <div class="row">
                        ...
                        <table class="table table-hover" id="dtable">
                            <thead>
                                <tr>
                                    ...
                                    <th class="">No</th>
                                    <th class="text-center" style="width: 30%">Video</th>
                            ...
                            <tbody>
                                ...
                                foreach ($media as $i) {
                                    ...
                                    <tr>
                                        ...
                                        <td class=""><?php echo html_entity_decode($i['description'])?></td>
                                        ...
                                        <td class="text-center">
                                            <a href="<?php echo site_url('manage/media/video/edit/' . $i['id']) ?>" class="btn btn-default btn-sm" title="Edit"><i class="fa fa-edit text-primary"></i></a>
                                            <button id="delete" type="button" class="btn btn-default btn-sm" data-url="<?php echo site_url('manage/media/video/delete/' . $i['id']) ?>" data-toggle="modal" data-target="#delete-modal" data-backdrop="static" data-keyboard="false" title="Hapus"><i class="fa fa-close text-danger"></i></button>
                                        </td>
                                    </tr>
                                    <?php
                                    $no+=1;
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content modal-confirm">
            <div class="modal-body text-center text-semi-bold">
                ...
                <p>Video ini akan dihapus. Lanjutkan ?</p>
