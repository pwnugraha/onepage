                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            <div class="input-group">
                                <input type="text" class="form-control" readonly="" id="source-img" value="<?php echo base_url() . $image['dir'] . $image['name'] ?>">
                                <a onclick="copyText()" tabindex="0" class="input-group-addon btn btn-primary" role="button" data-toggle="popover" data-trigger="focus" data-placement="top" data-content="Copied"><i class="fa fa-fw fa-copy"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
